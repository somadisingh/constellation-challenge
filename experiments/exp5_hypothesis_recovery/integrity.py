"""Protected-artifact hashing for Experiment 5. Broader than Experiment 4C's
own list: 5 must additionally never modify Experiment 4C's own outputs,
since 5 reads them read-only (hypothesis dataset, gates, completion audit) to
ground its oracle audit and branch decision.
"""
