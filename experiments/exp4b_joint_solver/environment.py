"""Environment / source-hash recording for Experiment 4B (mirrors Exp4's
own environment.py verbatim in structure)."""
...
def record_source_hashes(say=print) -> dict:
    ...
    files = sorted((ROOT / 'experiments' / 'exp4b_joint_solver').glob('*.py'))
